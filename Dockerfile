...
LABEL org.opencontainers.image.authors="Pongsagorn Thiamuthai <Pongsagorn2003@gmail.com>"
...
COPY ./cacti/cacti-spine-latest.tar.gz /cacti_install/cacti-spine-latest.tar.gz
COPY ./cacti/cacti-latest.tar.gz /cacti_install/cacti-latest.tar.gz
## --- SERVICE CONFIGS ---
